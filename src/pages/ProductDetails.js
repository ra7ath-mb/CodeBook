...
const ProductDetails = () => {
    ...
    return (
      <main>
        <section className="my-10 text-center">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-slate-200">Product unavailable</h1>
          <p className="mt-3 text-lg text-gray-900 dark:text-slate-200">{error}</p>
        </section>
      </main>
    );
  }
  ...
  if(!product){
    return (
      <main>
        <section className="my-10 text-center">
          <p className="text-lg text-gray-900 dark:text-slate-200">Loading product...</p>
        </section>
      </main>
    );
  }
