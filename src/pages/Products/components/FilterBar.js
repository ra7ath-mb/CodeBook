          ...
          <ul className="text-slate-700 dark:text-slate-100">
            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input
                  onChange={() =>
                    dispatch({ type: "RATING", payload: "4STARS_AND_ABOVE" })
                  }
                  checked={state.rating === "4STARS_AND_ABOVE"}
                  id="rating-sort-1"
                  type="radio"
                  value=""
                  name="rating-sort"
              ...
              <div className="flex items-center my-1">
                <input
                  onChange={() =>
                    dispatch({ type: "RATING", payload: "3STARS_AND_ABOVE" })
                  }
                  checked={state.rating === "3STARS_AND_ABOVE"}
                  id="rating-sort-2"
                  type="radio"
                  value=""
                  name="rating-sort"
              ...
              <div className="flex items-center my-1">
                <input
                  onChange={() =>
                    dispatch({ type: "RATING", payload: "2STARS_AND_ABOVE" })
                  }
                  checked={state.rating === "2STARS_AND_ABOVE"}
                  id="rating-sort-3"
                  type="radio"
                  value=""
                  name="rating-sort"
              ...
              <div className="flex items-center my-1">
                <input
                  onChange={() =>
                    dispatch({ type: "RATING", payload: "1STAR_AND_ABOVE" })
                  }
                  checked={state.rating === "1STAR_AND_ABOVE"}
                  id="rating-sort-4"
                  type="radio"
                  value=""
                  name="rating-sort"
